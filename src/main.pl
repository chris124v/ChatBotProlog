...
:- prolog_load_context(directory, SrcDir),
   ...
   directory_file_path(KBDir, 'base_conocimiento_b.pl', KBB),
   ...
   consult(KBB),                                            % Base del Miembro 2 (50+ hechos - Slang Internet)
   consult(KBC),                                            % Base del Miembro 3 (50+ hechos - UFC)
   consult(KBD).                                            % Base del Miembro 4 (50+ hechos - Ciencias)
% :- consult('BasesConocimiento/base_conocimiento_i.pl').   % Base del Miembro 5 (50+ hechos - Por crear)
